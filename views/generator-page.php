...
<div class="wrap afgfa-generator-wrap">
	...
	<!-- Field Preview Table -->
	<div class="afgfa-section afgfa-field-preview" style="display:none;">
		...
		<table class="wp-list-table widefat fixed striped" id="afgfa-fields-table">
			<thead>
				<tr>
	...
	<!-- Generation Controls -->
	<div class="afgfa-section afgfa-generate-controls" style="display:none;">
